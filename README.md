...
git clone https://github.com/jandersoncosta97/calculadora_simples.git

#### 3 - Abra o respositório com sua IDE

#### 4 - Digite dotnet run para executar o programa calculadora_simples
